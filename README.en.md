...
> English summary. The [Korean README](README.md) is the primary document, including the full engineering changelog (55 documented find-fix cycles, plus 7 fixes that predate the changelog — see [CHANGELOG.md](CHANGELOG.md)).
...
[![Version](https://img.shields.io/badge/Version-1.9.9-orange.svg)]()
...
| Documented find-fix cycles | 55 changelog entries (symptom → root cause → measured verification), plus 7 fixes that predate the changelog |

## Engineering highlights

The [changelog](CHANGELOG.md) documents 55 find-fix cycles in "symptom → root cause → measured verification" form. Selected findings:
...
The numbered changelog (#1–#55) starts at `v1.0.1` (2026-07-16), when the
