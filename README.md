...
| RAGAS Faithfulness / Context Recall | **0.86 / 0.93** (30케이스, gpt-4o-mini judge) |
...
**결과**: 조문 **1,436 → 1,629개 (+193 복구)**. E2E 검증: "재난 및 안전관리 기본법 제14조의2" 질의가 정확한 조문 + "제14조의2" 표시 + 올바른 법령정보원 링크로 응답. RAGAS **Faithfulness 0.74 → 0.86 (+16%)** — 소실 조문 복구로 근거 충실도 상승, 나머지 지표 안정 (recall 0.93 유지). 검색 Top-3 recall 83.3% 유지, 멀티턴 5/5, pytest 49개(정규화 회귀 테스트 3개 추가) 통과.
