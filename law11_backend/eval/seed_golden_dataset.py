...
ARTICLES_TO_SEED = [
    ...
    ("산업안전보건법", "76",  "특수형태근로종사자에 대한 안전조치 의무는 무엇인가요?",                "concept"),

    # ── 산업안전보건기준에관한규칙 (10개) ─────────────────────
    ("산업안전보건기준에관한규칙", "32",  "산업안전보건기준에 관한 규칙 제32조의 내용은?",            "direct_article"),
    ("산업안전보건기준에관한규칙", "55",  "비계 설치 시 준수해야 할 안전 기준은 무엇인가요?",         "standard"),
    ("산업안전보건기준에관한규칙", "100", "거푸집 동바리 설치 기준은 어떻게 되나요?",                  "standard"),
    ("산업안전보건기준에관한규칙", "132", "전기기계·기구 사용 시 감전 방지 기준은?",                   "standard"),
    ("산업안전보건기준에관한규칙", "144", "충전전로 인근 작업 시 안전거리 기준은?",                    "standard"),
    ("산업안전보건기준에관한규칙", "200", "폭발 위험 분위기에서의 작업 기준은?",                       "standard"),
    ("산업안전보건기준에관한규칙", "380", "굴착 작업 시 지반 붕괴 방지 조치는?",                       "standard"),
    ("산업안전보건기준에관한규칙", "420", "유해물질 취급 시 필요한 안전조치는?",                       "standard"),
    ("산업안전보건기준에관한규칙", "440", "관리대상 유해물질 취급 사업장 기준은?",                     "concept"),
    ...
    ("재난및안전관리기본법", "14", "중앙재난안전대책본부의 구성 및 역할은?",                           "concept"),
    ("재난및안전관리기본법", "26", "재난관리자원 비축 의무 기준은 무엇인가요?",                        "standard"),
    ("재난및안전관리기본법", "34", "재난관리기금 적립 기준은?",                                        "standard"),
    ("재난및안전관리기본법", "38", "재난예방조치 의무 내용은 무엇인가요?",                             "concept"),
]
