...
LABELED_CASES: List[Dict] = [
    ...
    # "계단이 위험해 보여" 같은 단문 관찰 발화는 실사용에서 나올 가능성이 낮아,
    # 실제 사용자가 칠 법한 장문 실무 질문으로 교체 (2026-07-18)
    {"question": "오래된 건물이라 계단도 오래됐을텐데 어떤 안전성 평가를 기준으로 또는 어떤 법적 기준으로 평가하는게 좋을까", "label": "law"},
